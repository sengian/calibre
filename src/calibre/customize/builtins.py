...
from calibre.ebooks.metadata.sources.doi import DOI
...
plugins += [GoogleBooks, GoogleImages, Amazon, Edelweiss, OpenLibrary, ISBNDB,
            DOI, OverDrive, Douban, Ozon, BigBookSearch]
